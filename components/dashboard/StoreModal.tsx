    ...
    >
      ...
      >
        ...
        <div className="space-y-4 relative z-10">
          ...
          {/* Item: Streak Freeze */}
          <div className="flex items-center justify-between bg-gradient-to-br from-blue-900/40 to-blue-900/10 border border-blue-500/20 rounded-2xl p-5 hover:border-blue-500/50 transition-all group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-blue-500/20 flex items-center justify-center text-blue-400 border border-blue-500/30 group-hover:scale-110 transition-transform">
                <ShieldAlert size={24} />
              </div>
              <div>
                <h3 className="font-bold text-white text-lg">Streak Freeze</h3>
                <p className="text-sm text-blue-200/60 max-w-[200px]">Protects your streak if you miss one day. Equips automatically.</p>
                <div className="text-xs font-bold text-blue-400 mt-1">You own: {profile.streak_freezes || 0}</div>
              </div>
            </div>
            ...
            <button
              ...
              className="flex flex-col items-center justify-center px-6 py-2 bg-white/10 hover:bg-amber-500/20 hover:border-amber-500/50 border border-white/10 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <Loader2 size={18} className="animate-spin text-amber-400" />
              ) : (
                <>
                  <span className="text-xs text-gray-400 font-medium mb-0.5">BUY</span>
          ...
          <div className="flex items-center justify-between bg-white/[0.02] border border-white/5 rounded-2xl p-5 opacity-50 grayscale cursor-not-allowed">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-white text-lg">Neon Lotus Seed</h3>
                <p className="text-sm text-gray-400 max-w-[200px]">Unlock a legendary glowing plant for your dashboard.</p>
              </div>
            </div>
            <div className="px-6 py-3 bg-white/5 rounded-xl text-gray-500 font-bold text-sm">
              Coming Soon
            </div>
          </div>
